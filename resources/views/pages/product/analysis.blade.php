...
@section("content")
    ...
    <section class="py-10 lg:pt-32 lg:pb-24 with__border--bottom" id="analysis">
        <div class="container mx-auto md:flex-no-wrap md:flex-row-reverse flex-wrap flex justify-between items-center">
            @include('components.product.image_text_horizontal',
                [
                'heading' => 'All quality and safety results <span class="text-purple">in one system </span>',
                'headingColor' => 'primary',
                'text' => 'View the results of all inspections and issues in the Lumiform desktop app. Get full transparency about who conducted which inspection or resolved which issue, when and where.  .',
                'image' => 'group-1916.svg',
                'withButton' => [
                'text' => 'Get Lumiform FREE',
                'url' => '#'
                ],
                'reversed' => true
                ]
    ...
    <section  class="py-10 lg:pt-32 lg:pb-24 with__border--bottom">
        <div class="container mx-auto custom-text-size">
            ...
            @include('components.product.image_text_horizontal',
                [
                'heading' => 'Create fully customised report templates',
                'headingColor' => 'green',
                'text' => '
                        ...
                        . Use both fields, which are automatically filled out by the system (date and inspector) and individual queries, such as comment fields or second inspector..',
                'image' => 'group-1743.svg',
                ]
                )
            @include('components.product.image_text_horizontal',
               [
               'heading' => 'Create and secure reports securely and automatically',
