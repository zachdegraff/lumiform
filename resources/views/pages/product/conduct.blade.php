...
@section("content")
    ...
    <section id="from" class="py-12 lg:py-24 with__border--bottom relative">
        <div class="container mx-auto md:flex justify-between">
            ...
            <div class="from__text w-full md:w-5/12">
                <p class="mb-12 font-light font-din md:text-20 lg:text-30 text-secondary tracking-text">
    ...
    <section id="as_a_team" class="py-12 lg:py-32 with__border--bottom">
        ...
        <div class="container mx-auto text-center lg:text-left flex flex-wrap lg:flex-no-wrap justify-around">
            <div class="team__itemw-full sm:w-1/2  mb-10 px-5 lg:px-0">
            ...
            <div class="team__itemw-full sm:w-1/2  mb-10 px-5 lg:px-0">
                <img src="{{asset('img/group-5239.png')}}" alt=""
                     ...
                     class="mb-16 mx-auto lg:mx-0 sm:max-h-1/4 lg:max-h-1/2">
                <h3 class="font-cocogoose font-black text-gold uppercase text-20 md:text-38 mb-10">
    ...
    <section id="as_a_team" class="py-12 lg:py-32 with__border--bottom">
        ...
        <div class="container mx-auto text-center lg:text-left flex flex-wrap lg:flex-no-wrap justify-between">
            ...
            <div class="team__itemw-full sm:w-1/2 lg:w-1/5 mb-10 px-5 lg:px-0">
                ...
                <h3 class="font-cocogoose font-black text-green uppercase text-15 md:text-34 mb-20">
            ...
            <div class="team__itemw-full sm:w-1/2 lg:w-1/5 mb-10 px-5 lg:px-0">
                ...
                <h3 class="font-cocogoose font-black text-gold uppercase text-15 md:text-34 mb-20">
            ...
            <div class="team__item w-full sm:w-1/2 lg:w-1/5 mb-10 px-5 lg:px-0">
                ...
                <h3 class="font-cocogoose font-black text-purple uppercase text-15 md:text-34 mb-10">
            ...
            <div class="team__item w-full sm:w-1/2 lg:w-1/5 mb-10 px-5 lg:px-0">
                ...
                <h3 class="font-cocogoose font-black text-red uppercase text-15 md:text-34 mb-10">
