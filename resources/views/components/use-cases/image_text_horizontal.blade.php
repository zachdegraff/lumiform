    ...
    <div class="flex justify-around items-center @if (isset($reversed) && $reversed == true) flex-row-reverse @endif">
        ...
        <div class="w-1/2">
            <div class="cases__text__section  mx-auto">
                <h3 class="text-50 font-cocogoose uppercase text-primary mb-12">{!! $heading !!}</h3>
                <ul class="use-cases__list mb-12">
                ...
                <p class="pl-10 py-5 border-l-4 border-{{$bottom['borderColor']}} text-20 font-light font-din text-secondary"> {!! $bottom['text'] !!}</p>
            </div>
        </div>
    </div>
</div>